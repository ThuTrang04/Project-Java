...
// Lớp SinhVienTrungCap kế thừa từ SinhVien
public class SinhVienTrungCap extends SinhVien {
    ...
    public SinhVienTrungCap(String maSV, String hoTen, String gioiTinh, Date ngaySinh, double diemThiTotNghiep) {
    ...
    public void hienThiToanBoThongTin() {
        System.out.println("=== THÔNG TIN SINH VIÊN TRUNG CẤP ===");
        hienThiThongTin();
        System.out.println("Điểm thi tốt nghiệp: " + diemThiTotNghiep);
        System.out.println("Xếp loại: " + xepLoai);
        System.out.println("Thời gian đào tạo: 2 năm (Niên chế)");
